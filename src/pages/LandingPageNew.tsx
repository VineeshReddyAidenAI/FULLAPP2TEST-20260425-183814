  ...
  return (
    <div className="font-[Noto_Sans] min-h-screen w-full flex flex-col bg-white bg-gradient-to-b from-[#005eb8]/[0.07] to-[#5c55eb]/[0.07]">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        {/* Left Side - Form */}
        <div className="w-full md:flex-1 flex flex-col justify-center items-center p-[24px] md:p-[48px] bg-white bg-gradient-to-b from-[#005eb8]/[0.07] to-[#5c55eb]/[0.07]">
          <div className="w-full max-w-[420px] bg-white/[0.70] bg-[radial-gradient(circle,_rgba(255,255,255,0.56)_0%,_rgba(255,255,255,0.08)_100%)] rounded-[24px] shadow-[0px_1px_4px_rgba(0,0,0,0.05)] p-[32px] flex flex-col items-center gap-[32px]">
            {/* Header */}
            ...
            <div className="flex flex-col items-center gap-[24px] w-full">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-[10px] px-[16px] py-[12px] w-[200px] h-[42px] bg-white border border-[#005eb8] rounded-[8px] shadow-[0px_1px_4px_rgba(0,0,0,0.05)] cursor-pointer hover:opacity-90 transition-opacity"
              >
